      ...
      <div className="home__container container grid">
        ...
        <div className="home__data">
          ...
          <p className="home__data-description">
            We are a sports science firm that focuses on all level athletes from grassroots to Elite level to enhance performance through evidence-based, athlete-centric programs.
          </p>
        ...
        <div className="home__info">
          ...
          <div className="home__info-overlay">
            <div className="home__info-stats">
              ...
              <div className="home__info-stat">
                <span className="home__info-number">1000+</span>
                <span className="home__info-label">Athletes Trained</span>
              </div>
              <div className="home__info-stat">
                <span className="home__info-number">6+</span>
                <span className="home__info-label">Sports Disciplines</span>
              </div>
            </div>
          </div>
        </div>
